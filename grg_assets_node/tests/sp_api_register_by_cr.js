...
let option = {
    ...
    path: '/sp_api/register_by_cr', //斜杠开头
    method: 'POST',
...
let params = {
    ...
    cr_type: test_config.test_user[0].cr_type,
    cr_num: test_config.test_user[0].cr_num,
    cr_name: test_config.test_user[0].cr_name,
    mobile: test_config.test_user[0].mobile,
...
async.waterfall([
    ...
    function (data, callback) {
        params.signature = common_utils.genSignature("" + params.sp_id + params.cr_type + params.cr_num +
            params.cr_name + params.mobile + params.query_time,
            key, iv);
