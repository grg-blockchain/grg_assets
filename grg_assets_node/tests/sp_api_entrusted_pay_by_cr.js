...
let option = {
    ...
    path: '/sp_api/entrusted_pay_by_cr', //斜杠开头
    method: 'POST',
...
async.waterfall([
    ...
    function (data, callback) {
        params.signature = common_utils.genSignature("" + params.sp_id + params.cr_type + params.cr_num + params.score + params.query_time,
            sp_key, sp_iv);
        console.log(params);
